...
export default async function MyProfilePage() {
  ...
  const { data: profile } = await supabase.from('users').select('id, name, phone, avatar_url, street_id, estate_id').eq('id', user.id).maybeSingle();
